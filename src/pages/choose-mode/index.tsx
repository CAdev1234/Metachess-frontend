  ...
  return (
    <div className="choseModeContainer m-auto">
      ...
      {choseMode === MODES.PVP_MODE && (
        <ChoosePVPModeSection setMode={props.setChoseMode} gameMode={GAME_MODES.TWO_DIMENSION} />
      )}
      ...
      {choseMode === MODES.PLAY_AI && (
        <PlayWithAISection setPlayMode={setAIPlayMode} goBack={onGoBack} gameMode={GAME_MODES.TWO_DIMENSION} />
      )}
      {choseMode === MODES.PLAY_WITH_HUMAN && (
        <PlayWithHumanSection goBack={onGoBack} onJoinRoom={onJoinRoom} gameMode={GAME_MODES.TWO_DIMENSION}  />
      )}
